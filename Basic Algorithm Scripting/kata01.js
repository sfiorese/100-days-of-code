function songDecoder(song){
    // ...
    var expression = /WUB/gi;
    var mySong = song.replace(expression, ' ');
    mySong = mySong.replace(/([\ \t]+(?=[\ \t])|^\s+|\s+$)/g, '');
    return mySong;
  }
...
Reference:
https://blog.outbook.es/desarrollo-web/javascript-y-expresiones-regulares-eliminacion-de-espacios-y-tabulaciones-en-una-cadena
